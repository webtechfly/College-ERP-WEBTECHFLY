...
import { Visibility, VisibilityOff, School, Shield, ArrowForward } from "@mui/icons-material";
...
const StudentLogin = () => {
  ...
  return (
    <div className="min-h-screen w-full flex justify-center items-center bg-[#05070a] selection:bg-cyan-500/30 relative overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-5xl h-[600px] flex overflow-hidden rounded-[2rem] border border-white/10 shadow-2xl bg-[#0a0c14]/80 backdrop-blur-3xl m-4">
        ...
        <div className="hidden lg:flex w-1/2 bg-gradient-to-br from-cyan-600/20 to-blue-900/40 p-12 flex-col justify-between relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <h2 className="text-4xl font-extrabold text-white leading-tight">
              Student <span className="text-cyan-400">Portal</span> <br />
              Access with Ease.
            </h2>
            <p className="mt-4 text-gray-400 max-w-sm">
              Track attendance, view grades, and stay organized with our unified student portal.
            </p>
          </div>
          ...
          <div className="relative z-10 flex items-center gap-4 text-xs text-gray-500 uppercase tracking-widest">
            ...
            End-to-End Encrypted Student Access
          </div>
        </div>
        ...
        <div className="w-full lg:w-1/2 p-8 md:p-12 flex flex-col justify-center bg-white/[0.02]">
          <div className="mb-10 text-center lg:text-left">
            <h3 className="text-2xl font-bold text-white mb-2">Student Login</h3>
